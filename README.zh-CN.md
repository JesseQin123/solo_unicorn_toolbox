...
| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [affaan-m/ECC](https://github.com/affaan-m/ECC) | agent harness 性能优化系统：skills、本能、记忆、安全、research-first 开发，兼容 Claude Code、Codex、Opencode、Cursor 等主流 coding agent。 | JavaScript | 240.6k | `ai-agents` `anthropic` `claude` `claude-code` |
...
| [garrytan/gstack](https://github.com/garrytan/gstack) | Garry Tan 的 Claude Code 配置：23 个工具，扮演 CEO、Designer、Eng Manager、Release Manager、Doc Engineer、QA | TypeScript | 128.3k |  |
| [Leonxlnx/taste-skill](https://github.com/Leonxlnx/taste-skill) | Taste-Skill：给 AI 注入审美，避免生成粗糙、千篇一律的内容 | JavaScript | 77.2k | `agent` `ai` `claude` `claude-code` |
...
| [Donchitos/Claude-Code-Game-Studios](https://github.com/Donchitos/Claude-Code-Game-Studios) | 将 Claude Code 打造为完整游戏开发工作室，含 49 个 AI agent、72 个 workflow skill 及模拟真实工作室层级的协作系统 | Shell | 24k | `ai-agents` `ai-assisted-development` `anthropic` `claude` |
| [1jehuang/jcode](https://github.com/1jehuang/jcode) | Coding Agent Harness | Rust | 17.8k | `ai` `ai-agent` `ai-coding-agent` `claude` |
...
| [AMAP-ML/LongHorizon-Harness](https://github.com/AMAP-ML/LongHorizon-Harness) | 长时域计算机操作 harness，让 AI agent 跨桌面应用和 CLI 长期运行，原生集成 Claude Code、Codex 与 OpenClaw。 | Python | 798 | `agent` `claude` `claude-code` `claude-plugin` |
...
| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) | 专为 Codex 与 OpenCode 用户设计的复杂代码库 coding agent harness，具备项目记忆与执行验证能力。 | TypeScript | 68k | `ai` `ai-agents` `anthropic` `chatgpt` |
...
| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | OpenClaw：你自己的个人 AI 助手，跨任意 OS 与平台 🦞 | TypeScript | 386.5k | `ai` `assistant` `crustacean` `molty` |
...
| [paperclipai/paperclip](https://github.com/paperclipai/paperclip) | Paperclip：零员工公司的开源编排框架 | TypeScript | 78.6k |  |
| [HKUDS/nanobot](https://github.com/HKUDS/nanobot) | "🐈 nanobot: The Ultra-Lightweight Personal AI Agent" | Python | 47.1k | `agent-framework` `ai-agent` `ai-agents` `chatbot` |
...
| [nesquena/hermes-webui](https://github.com/nesquena/hermes-webui) | Hermes WebUI：从网页或手机使用 Hermes Agent 的最佳方式 | Python | 17.4k | `agent` `ai-agents` `hermes` `hermes-agent` |
| [fathah/hermes-desktop](https://github.com/fathah/hermes-desktop) | Hermes Agent 的桌面端伴侣应用，方便本地管理和运行 Hermes AI 智能体。 | TypeScript | 13.9k | `ai` `ai-agent` `autonomous-agents` `chatbot` |
...
| [EKKOLearnAI/hermes-studio](https://github.com/EKKOLearnAI/hermes-studio) | Hermes Agent 的 Web 控制台，支持多平台 AI 对话、会话管理、定时任务与使用量分析。 | TypeScript | 10.4k | `agent` `ai-agent` `chat-ui` `dashboard` |
...
| [awizemann/scarf](https://github.com/awizemann/scarf) | 🪟 Hermes Agent 的 macOS / iOS 原生 GUI — 多窗口、多服务（本地+远端）。 | Swift | 811 | `ai-agent` `gui` `hermes` `macos` |
...
| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [bytedance/deer-flow](https://github.com/bytedance/deer-flow) | 字节出品的开源 long-horizon SuperAgent harness，做研究/写代码/创作，沙盒、记忆、工具、skill、subagent 一应俱全 | Python | 80.1k | `agent` `agentic` `agentic-framework` `agentic-workflow` |
| [FoundationAgents/MetaGPT](https://github.com/FoundationAgents/MetaGPT) | MetaGPT 多智能体框架，首个 AI 软件公司范式，支持自然语言驱动的软件开发全流程 | Python | 69.9k | `agent` `gpt` `llm` `metagpt` |
| [ruvnet/ruflo](https://github.com/ruvnet/ruflo) | 🌊 主流的 Claude agent 编排平台：智能多 agent swarm、自治工作流、对话式 AI 系统 | TypeScript | 68k | `agentic-ai` `agentic-framework` `agentic-workflow` `agents` |
...
| [multica-ai/multica](https://github.com/multica-ai/multica) | 开源的 managed agents 平台，把 coding agent 变成可分配任务、可追踪进度的真队友 | Go | 46.3k |  |
| [langchain-ai/langgraph](https://github.com/langchain-ai/langgraph) | 用于构建有状态多智能体 AI 应用的图编排框架，支持 LangChain 生态与自定义 agent 循环和工作流。 | Python | 39.8k | `agents` `ai` `ai-agents` `chatgpt` |
...
| [superset-sh/superset](https://github.com/superset-sh/superset) | Code Editor for the AI Agents Era - Run an army of Claude Code, Codex, etc. on your machine | TypeScript | 13k | `ade` `agent` `agent-orchestration` `ai-agents` |
| [Untrivial-ai/agent-orchestrator](https://github.com/Untrivial-ai/agent-orchestrator) | 编码 agent 集群 IDE，内置 orchestrator 自动规划任务、并行派发 agent 并处理 CI 修复与代码评审。 | Go | 9.6k | `agent-fleet` `agent-swarm` `claude-code` `codex-cli` |
...
| [huangruiteng/loopx](https://github.com/huangruiteng/loopx) | 面向长时运行 AI agent 团队的轻量级循环状态内核，支持 Codex、Claude Code 等多框架的持久目标与任务交接。 | Python | 4.8k | `agent-control-plane` `agent-harness` `agent-ops` `ai-agents` |
...
| [deerwork-ai/deer-workflow](https://github.com/deerwork-ai/deer-workflow) | 开源图工程运行时，用 TypeScript 定义编排逻辑，将语义任务委托给可热替换的 agent runtime 并行执行。 | TypeScript | 475 | `agent` `ai` `ai-agent` `ai-agents` |
...
| [krishagarwal314/CodeJury](https://github.com/krishagarwal314/CodeJury) | 多智能体软件交付流水线，覆盖需求梳理、代码实现、测试执行与集成 RAG 的 PR 代码评审全流程。 | Python | 140 | `agentic-ai` `ai-agents` `autonomous-agents` `claude` |
...
| [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) | 开源的 AI agent，把 Gemini 的能力直接带到终端 | TypeScript | 106.5k | `ai` `ai-agents` `cli` `gemini` |
| [earendil-works/pi](https://github.com/earendil-works/pi) | pi：全能 AI agent toolkit，统一 LLM API、agent loop、TUI 与 coding agent CLI，TypeScript 实现。 | TypeScript | 92k |  |
| [odysseus-dev/odysseus](https://github.com/odysseus-dev/odysseus) | Odysseus：开源自托管 AI 工作空间，集聊天、工具调用与多 agent 管理于一体 | Python | 85.5k |  |
...
| [lobehub/lobehub](https://github.com/lobehub/lobehub) | LobeHub：协同 agent 团队的工作与生活空间，多 agent 协作、agent 团队设计、agent 作为工作交互单元 | TypeScript | 81.8k | `agent` `agent-collaboration` `agent-harness` `ai` |
| [cline/cline](https://github.com/cline/cline) | Cline：IDE 内的自治 coding agent，可创建/编辑文件、执行命令、使用浏览器 | TypeScript | 66.3k |  |
| [Mintplex-Labs/anything-llm](https://github.com/Mintplex-Labs/anything-llm) | AnythingLLM：一体化的 AI 生产力加速器，本地优先，免恼人配置 | JavaScript | 64.8k | `agent-computer` `agent-harness` `agent-orchestration` `agentic-ai` |
| [CherryHQ/cherry-studio](https://github.com/CherryHQ/cherry-studio) | Cherry Studio：智能聊天、自治 agent、300+ 助手的 AI 生产力工作室，统一接入前沿 LLM | TypeScript | 50.6k | `agent-skills` `ai-agent` `claude-code` `codex` |
| [zhayujie/CowAgent](https://github.com/zhayujie/CowAgent) | CowAgent（原 chatgpt-on-wechat）：开源超级 AI 助手与 Agent Harness，支持 MCP、Skills、Memory，多模型多渠道，一行命令安装。 | Python | 46.5k | `ai` `ai-agent` `ai-agents` `chatgpt-on-wechat` |
...
| [CopilotKit/CopilotKit](https://github.com/CopilotKit/CopilotKit) | The Frontend Stack for Agents & Generative UI. React + Angular.  Makers of the AG-UI Protocol | TypeScript | 36.8k | `agent` `agent-native` `agentic-ai` `agents` |
| [iOfficeAI/AionUi](https://github.com/iOfficeAI/AionUi) | 免费、本地、开源的 24/7 Cowork 应用，支持 OpenClaw/Hermes/Claude Code/Codex/OpenCode/Gemini CLI 等 20+ CLI | TypeScript | 32.1k | `acp` `agent-team` `ai` `ai-agent` |
| [herdrdev/herdr](https://github.com/herdrdev/herdr) | Herdr — 专为 coding agent 设计的高性能 Rust 运行时，让各类 AI 编程 agent 统一运行。 | Rust | 29.9k | `agent` `agent-orchestration` `ai` `ai-agents` |
| [ComposioHQ/composio](https://github.com/ComposioHQ/composio) | Composio：1000+ 工具包、tool search、上下文管理、鉴权和沙盒工作台，帮助构建把意图变成行动的 AI agent | TypeScript | 29.7k | `agentic-ai` `agents` `ai` `ai-agents` |
...
| [xai-org/grok-build](https://github.com/xai-org/grok-build) | xAI 出品的编码 Agent Harness 与全屏 TUI，支持鼠标交互与插件扩展 | Rust | 25.5k |  |
...
| [HKUDS/OpenHarness](https://github.com/HKUDS/OpenHarness) | 开源 Agent Harness，内置个人 AI Agent Ohmo，提供完整的智能体运行与管理平台。 | Python | 15.4k |  |
| [yc-software/qm](https://github.com/yc-software/qm) | YC 出品的多人协作 agent 工作平台，支持团队共同调度 AI agent 并行完成复杂工作任务。 | TypeScript | 13.7k | `ai` `assistant` `harness` `qm` |
...
| [anywhere-labs/deepseek-harness-desktop](https://github.com/anywhere-labs/deepseek-harness-desktop) | DeepSeek Harness 桌面端：为 DSH 插件生态打造的现代化桌面应用，万物皆插件架构。 | TypeScript | 10.9k | `cordis` `cordis-plugin` `deepseek` `deepseek-harness` |
...
| [anthropics/claude-agent-sdk-python](https://github.com/anthropics/claude-agent-sdk-python) | 暂无描述 | Python | 7.9k |  |
...
| [OpenMinis/OpenMinis](https://github.com/OpenMinis/OpenMinis) | OpenMinis：跨平台免费开源的 AI Agent 应用，Swift 实现，适配多终端。 | Swift | 3.7k |  |
...
| [OpenBMB/StaffDeck](https://github.com/OpenBMB/StaffDeck) | StaffDeck：OpenBMB 出品的企业数字员工平台，支持大规模 AI agent 员工管理与任务分配。 | Python | 1.6k |  |
| [HKUDS/OpenOPC](https://github.com/HKUDS/OpenOPC) | OpenOPC：构建个人 AI 原生公司的自建、自运营开源框架 | Python | 1.4k |  |
| [TencentCloud/Octop](https://github.com/TencentCloud/Octop) | 腾讯云开源的更智能自托管 AI 助手，支持多用户和多 agent 协作。 | Python | 958 | `agent` `agentic-ai` `ai` `ai-agent` |
| [HKUDS/AgentSpace](https://github.com/HKUDS/AgentSpace) | AgentSpace：人机协作工作空间，将人类与 AI Agent 整合为同一团队高效协作。 | TypeScript | 935 |  |
| [lemma-work/lemma-platform](https://github.com/lemma-work/lemma-platform) | Lemma：开源人机协作工作平台，人类与 AI Agent 在同一工作空间共同完成任务。 | Python | 380 | `ai` `harness` `harness-ai` |

### 通用 / 研究型智能体 (20)

| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail) | 让 AI agent 像资深懒惰工程师一样思考——最好的代码是你永远不需要写的代码。 | JavaScript | 104.4k | `agent-skills` `ai-agents` `claude` `claude-code` |
| [karpathy/autoresearch](https://github.com/karpathy/autoresearch) | Karpathy 出品：在单 GPU 上自动跑 nanochat 训练研究的 AI agent | Python | 94k |  |
| [666ghj/MiroFish](https://github.com/666ghj/MiroFish) | 简洁通用的群体智能引擎，预测万物（agent-memory、社会预测、群体智能） | Python | 71.1k | `agent-memory` `financial-forecasting` `future-prediction` `knowledge-graph` |
| [FoundationAgents/OpenManus](https://github.com/FoundationAgents/OpenManus) | OpenManus：开放无围墙的通用 AI Agent 框架，致力于探索无硬性边界的智能体研究与任务执行。 | Python | 58k |  |
...
| [alibaba/open-code-review](https://github.com/alibaba/open-code-review) | 阿里巴巴开源的混合架构代码审查工具，结合确定性 pipeline 与 LLM Agent，支持精准行级注释与内置安全规则集。 | Go | 20.6k | `agent` `agent-skills` `code-review` `code-review-assistant` |
| [PrimeIntellect-ai/prime-agent](https://github.com/PrimeIntellect-ai/prime-agent) | 自我改进的 RLM 编程 agent，专为复杂编码工作流和长期自主任务设计。 | TypeScript | 16.7k |  |
...
| [lsdefine/GenericAgent](https://github.com/lsdefine/GenericAgent) | 自演化 agent：从 3.3K 行种子代码生长出 skill 树，达成全系统控制，token 消耗减少 6 倍 | Python | 13.8k | `ai-agent` `automation` `autonomous-agent` `browser-automation` |
| [Physical-Intelligence/openpi](https://github.com/Physical-Intelligence/openpi) | 暂无描述 | Python | 13.3k |  |
...
| [microsoft/Orchard](https://github.com/microsoft/Orchard) | 微软开源的 Agentic 建模框架，用于设计和实验复杂 AI agent 系统。 | — | 463 |  |
...
| [mattpocock/skills](https://github.com/mattpocock/skills) | Skills for Real Engineers. Straight from my .claude directory. | Shell | 219.8k |  |
| [nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) | AI SKILL：为多平台 UI/UX 提供专业设计智能 | Python | 117.5k | `ai-skills` `antigravity` `claude` `claude-code` |
| [Graphify-Labs/graphify](https://github.com/Graphify-Labs/graphify) | AI 编程助手 skill，可将任意代码库、SQL schema、脚本及文档转换为可查询的知识图谱，兼容 Claude Code、Codex、Cursor 等多种 AI 编码工具。 | Python | 107.3k | `ai-agents` `antigravity` `ast` `claude-code` |
| [Egonex-AI/Understand-Anything](https://github.com/Egonex-AI/Understand-Anything) | 将任意代码库转换为可交互知识图谱的 AI 工具，支持 Claude Code、Codex、Cursor、Copilot 等主流 coding agent。 | TypeScript | 79.6k | `antigravity-skills` `business-knowledge` `claude-code` `claude-skills` |
...
| [pbakaus/impeccable](https://github.com/pbakaus/impeccable) | Impeccable — 赋予 AI harness 设计语言的 skill，让 AI 生成内容拥有统一、精良的视觉标准。 | JavaScript | 59.8k |  |
| [mvanhorn/last30days-skill](https://github.com/mvanhorn/last30days-skill) | AI agent skill，可横跨 Reddit、X、YouTube、HN、Polymarket 等平台深度研究任意话题并生成有据可查的摘要 | Python | 58.4k | `ai-prompts` `ai-skill` `bluesky` `claude` |
| [ChromeDevTools/chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | 给 coding agent 用的 Chrome DevTools MCP server | TypeScript | 49.3k | `browser` `chrome` `chrome-devtools` `debugging` |
| [DeusData/codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp) | 高性能代码智能 MCP server，毫秒级将代码库索引为持久知识图谱，158 种语言，零依赖单一二进制。 | C | 39.2k | `aider` `ast` `claude-code` `code-analysis` |
| [blader/humanizer](https://github.com/blader/humanizer) | Claude Code skill，自动去除 AI 生成文本的机器痕迹，让输出更贴近自然人类写作风格。 | Python | 36.1k | `agent-skills` `ai-writing` `claude-code` `codex` |
| [K-Dense-AI/scientific-agent-skills](https://github.com/K-Dense-AI/scientific-agent-skills) | 即用型 Agent Skills：覆盖科研、科学、工程、分析、金融与写作 | Python | 33.7k | `agent-skills` `ai-scientist` `bioinformatics` `chemoinformatics` |
| [alchaincyf/nuwa-skill](https://github.com/alchaincyf/nuwa-skill) | 🧬 女娲.skill — 蒸馏任何人思维方式的元 skill，整个「人格蒸馏」热潮的起点。 | Python | 30.8k |  |
| [emilkowalski/skills](https://github.com/emilkowalski/skills) | 面向设计工程师的 AI agent skills，覆盖前端设计、UI/UX 工程与组件开发场景。 | Markdown | 29.9k |  |
...
| [iOfficeAI/OfficeCLI](https://github.com/iOfficeAI/OfficeCLI) | 专为 AI agent 设计的 Office 套件 CLI，无需安装 Office 即可读写 Word、Excel、PowerPoint，单一静态二进制。 | C# | 28.6k | `agent` `ai` `claude-code` `cli` |
| [OthmanAdi/planning-with-files](https://github.com/OthmanAdi/planning-with-files) | Claude Code skill：实现 Manus 风格的持久化 markdown 规划工作流 | Shell | 26.2k | `agent-skills` `autonomous-agents` `claude` `claude-code` |
| [phuryn/pm-skills](https://github.com/phuryn/pm-skills) | 100+ 条面向产品经理的 agentic skill，覆盖需求发现、策略制定、上线规划与增长全流程。 | — | 25.3k | `agent-skill-repository` `agent-skills` `agentic-skills` `claude-code-marketplace` |
...
| [KKKKhazix/khazix-skills](https://github.com/KKKKhazix/khazix-skills) | Khazix（数字生命）发布的开源 AI Skills 合集 | Python | 19.8k | `agent-skills` `ai-agents` `claude` `claude-code` |
| [microsoft/SkillOpt](https://github.com/microsoft/SkillOpt) | 微软出品的文本空间优化器，通过轨迹驱动编辑为冻结 LLM agent 训练可复用自然语言 Skills。 | Python | 16.1k | `agent-skills` `self-evolving-agents` |
...
| [greensock/gsap-skills](https://github.com/greensock/gsap-skills) | GSAP 官方发布的 AI Skills，教 AI 编程 agent 正确使用 GreenSock 动画库，包含最佳实践与常见动画模式 | — | 13.7k |  |
...
| [ConardLi/garden-skills](https://github.com/ConardLi/garden-skills) | ConardLi 开源 Skills 合集，涵盖网页设计、知识检索、图像生成等多种场景技能 | CSS | 10.4k | `agent` `claude` `gpt-image-2` `rag` |
...
| [dontbesilent2025/dbskill](https://github.com/dontbesilent2025/dbskill) | dontbesilent 的商业诊断 Skills，供 AI coding agent 作为商业分析工具调用。 | JavaScript | 9.6k |  |
| [kangarooking/cangjie-skill](https://github.com/kangarooking/cangjie-skill) | 仓颉 Skill：将书籍、长视频、播客等高价值内容蒸馏提炼为 AI agent 可执行的 Skills。 | Python | 8.1k | `agent-workflows` `ai-skills` `automation` `book-to-skill` |
...
| [worldwonderer/oh-story-claudecode](https://github.com/worldwonderer/oh-story-claudecode) | 网文写作全流程 skill 包，覆盖扫榜拆文、正文创作、去 AI 味与封面图生成，兼顾中英文小说创作。 | JavaScript | 5.7k | `ai-agent` `ai-writing` `chinese-novel` `claude-code` |
...
| [petergyang/no-ai-slop](https://github.com/petergyang/no-ai-slop) | no-ai-slop：自动去除文章中 20+ 种 AI 写作痕迹，让输出更自然真实。 | Python | 5.2k |  |
| [MengTo/Skills](https://github.com/MengTo/Skills) | 面向设计师与全栈开发者的 Agent skills 合集，兼容 Codex、Claude Code、Cursor 等多种 AI 编程助手。 | HTML | 4.9k |  |
...
| [0xNyk/council-of-high-intelligence](https://github.com/0xNyk/council-of-high-intelligence) | Claude Code 插件，召集 18 个 AI 人格跨多家 LLM 提供商进行多轮辩论，通过置信度加权输出决策建议。 | Shell | 4k | `agent-skill` `ai-agents` `claude-code` `codex` |
| [notdog1998/yourself-skill](https://github.com/notdog1998/yourself-skill) | 🪞 自己.skill — 蒸馏自己看清自己，欢迎加入数字永生 1.0。 | Python | 3.3k |  |
| [KKKKhazix/human-writing](https://github.com/KKKKhazix/human-writing) | human-writing Skill：让 AI 写的中文读起来像真实的人，通用创作与改稿技能，开箱即用。 | Python | 2.8k | `agent-skills` `chinese-writing` `creative-writing` `writing-skill` |
...
| [jinchenma94/bazi-skill](https://github.com/jinchenma94/bazi-skill) | 🔮 八字.skill — 四柱八字命理分析的 Claude Code Skill。 | — | 2.6k |  |
...
| [ythx-101/x-tweet-fetcher](https://github.com/ythx-101/x-tweet-fetcher) | 🦞 OpenClaw skill：无需登录或 API key，抓取 X/Twitter 的推文与回复 | Python | 934 | `agent-tools` `ai-agent` `automation` `no-api` |
| [alchaincyf/steve-jobs-skill](https://github.com/alchaincyf/steve-jobs-skill) | 🍎 乔布斯.skill — 6 个心智模型 + 8 条决策启发式 + 表达 DNA。 | — | 927 |  |
| [joeseesun/qiaomu-goal-meta-skill](https://github.com/joeseesun/qiaomu-goal-meta-skill) | 乔木 goal meta-skill — 将模糊的 Codex 任务转化为结构化 /goal 指令，自动生成验证步骤、操作约束与完成证据清单。 | Python | 854 |  |
...
| [modoojunko/awesome-novel-agent](https://github.com/modoojunko/awesome-novel-agent) | AI agent 小说创作助手 Skill，覆盖世界观搭建、角色塑造、章节规划和正文写作全流程。 | Python | 621 | `agent-skill` `ai-fiction` `ai-novel` `ai-skill` |
...
| [alchaincyf/elon-musk-skill](https://github.com/alchaincyf/elon-musk-skill) | 🚀 马斯克.skill — Elon Musk 的认知操作系统。 | — | 483 |  |
...
| [kkoppenhaver/cc-nano-banana](https://github.com/kkoppenhaver/cc-nano-banana) | 用 Nano Banana 生成图像的 Claude Code skill | — | 364 |  |
| [alchaincyf/munger-skill](https://github.com/alchaincyf/munger-skill) | 📊 芒格.skill — Charlie Munger 的认知操作系统。 | — | 341 |  |
| [xr843/Master-skill](https://github.com/xr843/Master-skill) | 🪷 高僧大德 AI 教学角色生成器（汉传/藏传/南传），数据源 CBETA / BDRC / Sutta。 | Rust | 320 | `agent-skills` `ai-persona` `bdrc` `buddhism` |
...
| [alchaincyf/karpathy-skill](https://github.com/alchaincyf/karpathy-skill) | 🤖 Karpathy.skill — Andrej Karpathy 的可运行思维框架。 | — | 292 |  |
...
| [alchaincyf/feynman-skill](https://github.com/alchaincyf/feynman-skill) | 🔬 费曼.skill — 理查德·费曼的认知操作系统。 | — | 246 |  |
| [vogtsw/boss-skills](https://github.com/vogtsw/boss-skills) | 👔 老板.skills — 把老板炼入 token，把生产力的解放留给自己。 | Python | 237 |  |
| [alchaincyf/naval-skill](https://github.com/alchaincyf/naval-skill) | 💎 纳瓦尔.skill — Naval Ravikant 的认知操作系统。 | — | 229 |  |
| [robbin/wechat-exporter](https://github.com/robbin/wechat-exporter) | 将 macOS 微信聊天记录导出并解密为纯文本 SQLite 数据库的 Claude Code / Codex skill。 | — | 203 |  |
| [alchaincyf/zhang-yiming-skill](https://github.com/alchaincyf/zhang-yiming-skill) | 🐉 张一鸣.skill — 张一鸣的认知操作系统。 | — | 158 |  |
...
| [alchaincyf/taleb-skill](https://github.com/alchaincyf/taleb-skill) | 🦢 塔勒布.skill — Nassim Taleb 的认知操作系统（黑天鹅、反脆弱）。 | — | 115 |  |
| [chendongqi/OPB-Skills](https://github.com/chendongqi/OPB-Skills) | 覆盖完整业务的 SKILL 集合，适用 Claude Code / Codex / OpenCode 等 | Python | 113 |  |
| [YIKUAIBANZI/forge-skill](https://github.com/YIKUAIBANZI/forge-skill) | 🔥 人格蒸馏引擎 forge-skill — 蒸馏自己/亲友的 Claude Code Skill。 | Python | 108 | `ai-agent` `claude-code` `claude-skill` `digital-twin` |
| [alchaincyf/mrbeast-skill](https://github.com/alchaincyf/mrbeast-skill) | 🎬 MrBeast.skill — 内容创造方法论的可运行版本，不是语录合集。 | Python | 101 |  |
...
| [norahe0304-art/30x-growth-marketing-panel](https://github.com/norahe0304-art/30x-growth-marketing-panel) | AI 增长营销专家面板，从 3,500+ YouTube 视频提炼 11 位世界级专家方法论，Claude Code Skill | Shell | 32 | `ai-agent-skill` `ai-skills` `claude-code` `growth-marketing` |
...
| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [browser-use/browser-use](https://github.com/browser-use/browser-use) | 🌐 让 AI agent 操作网页的自动化框架，让网站对 agent 友好 | Python | 109.5k | `ai-agents` `ai-tools` `browser-automation` `browser-use` |
| [microsoft/playwright](https://github.com/microsoft/playwright) | 微软出品的跨浏览器（Chromium/Firefox/WebKit）E2E 测试与自动化框架，单一 API | TypeScript | 94.6k | `automation` `chrome` `chromium` `e2e-testing` |
...
| [h4ckf0r0day/obscura](https://github.com/h4ckf0r0day/obscura) | 面向 AI agent 和网络爬虫的 Rust 无头浏览器，支持 CDP、Playwright/Puppeteer API 和反检测能力。 | Rust | 21.5k | `antidetect` `antidetect-browser` `browser` `browser-automation` |
| [trycua/cua](https://github.com/trycua/cua) | Open-source infrastructure for Computer-Use Agents. Sandboxes, SDKs, and benchmarks to train and evaluate AI agents that can control full desktops (macOS, Linux, Windows). | HTML | 21.4k | `agent` `ai-agent` `apple` `computer-use` |
| [browser-use/browser-harness](https://github.com/browser-use/browser-harness) | Browser Harness：自愈式 harness，让 LLM 完成任意浏览器任务 | Python | 16.7k | `ai-agent` `browser-agent` `browser-automation` `browser-use` |
...
| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [thedotmack/claude-mem](https://github.com/thedotmack/claude-mem) | A Claude Code plugin that automatically captures everything Claude does during your coding sessions, compresses it with AI (using Claude's agent-sdk), and injects relevant context back into future sessions. | JavaScript | 90.9k | `ai` `ai-agents` `ai-memory` `anthropic` |
| [colbymchenry/codegraph](https://github.com/colbymchenry/codegraph) | 为 Claude Code、Codex、Cursor、OpenCode、Hermes Agent 提供预构建代码知识图谱，减少 token 消耗与工具调用，完全本地运行。 | C | 66.7k |  |
...
| [run-llama/llama_index](https://github.com/run-llama/llama_index) | 领先的 RAG 框架 LlamaIndex，支持文档 agent 与 OCR 的一体化平台。 | Python | 51.7k | `agents` `application` `data` `fine-tuning` |
| [abhigyanpatwari/GitNexus](https://github.com/abhigyanpatwari/GitNexus) | GitNexus: The Zero-Server Code Intelligence Engine -       GitNexus is a client-side knowledge graph creator that runs entirely in your browser. Drop in a GitHub repo or ZIP file, and get an interactive knowledge graph wit a built in Graph RAG Agent. Perfect for code exploration | TypeScript | 45.5k |  |
...
| [tirth8205/code-review-graph](https://github.com/tirth8205/code-review-graph) | 本地优先代码智能知识图谱，兼容 MCP 与 CLI，为 AI coding 工具精准裁剪代码上下文，大幅减少 code review 时的 token 消耗。 | Python | 30.4k | `ai-coding` `claude` `claude-code` `code-review` |
| [topoteretes/cognee](https://github.com/topoteretes/cognee) | Memory control plane for AI Agents in 6 lines of code | Python | 30.1k | `agent-memory` `agent-skills` `ai` `ai-agents` |
| [getzep/graphiti](https://github.com/getzep/graphiti) | Graphiti：为 AI Agent 构建实时知识图谱 | Python | 30k | `agents` `graph` `llms` `rag` |
| [volcengine/OpenViking](https://github.com/volcengine/OpenViking) | OpenViking is an open-source context database designed specifically for AI Agents(such as openclaw). OpenViking unifies the management of context (memory, resources, and skills) that Agents need through a file system paradigm, enabling hierarchical context delivery and self-evolving. | Python | 28.8k | `agent-memory` `agent-plugins` `agentic-rag` `context-database` |
...
| [MemoriLabs/Memori](https://github.com/MemoriLabs/Memori) | Memori is agent-native memory infrastructure. A LLM-agnostic layer that turns agent execution and conversation into structured, persistent state for production systems. | Python | 16.1k | `agent` `agent-memory` `agenticai` `ai` |
...
| [EverMind-AI/EverOS](https://github.com/EverMind-AI/EverOS) | 跨平台便携记忆层，兼容 Claude Code、Codex、OpenClaw、Hermes 等主流 AI agent，本地优先 Markdown 原生。 | Python | 12.1k | `agent-memory` `agentic-ai` `ai` `chats` |
...
| [cocoindex-io/cocoindex](https://github.com/cocoindex-io/cocoindex) | CocoIndex：long horizon agent 的增量数据引擎（context engineering、RAG、agentic data framework） | Rust | 11.3k | `agentic-data-framework` `ai` `ai-agents` `change-data-capture` |
...
| [semantica-agi/semantica](https://github.com/semantica-agi/semantica) | Semantica：为生产级 AI 构建可解释知识图谱，支持推理引擎、来源溯源与治理 | Python | 8.4k | `agent-memory` `ai` `ai-governance` `ai-infrastructure` |
...
| [mnemosyne-oss/mnemosyne](https://github.com/mnemosyne-oss/mnemosyne) | 零依赖、亚毫秒级 AI 记忆系统，专为 Hermes Agent 及所有 AI 场景设计的开源记忆层。 | Python | 2.6k | `agents` `ai` `hermes` `hermes-agent` |
...
| [Zleap-AI/SAG](https://github.com/Zleap-AI/SAG) | SAG：将知识转化为宇宙图谱的图式知识引擎 | TypeScript | 2.4k | `agent` `ai` `data-engineering` `graphrag` |
...
| [neo4j-labs/neosemantics](https://github.com/neo4j-labs/neosemantics) | Neo4j 的 RDF / 语义扩展插件，支持 RDF 导入导出、SHACL 验证与知识图谱构建。 | Java | 956 | `knowledge-graph` `linked-data` `neo4j` `ontologies` |
...
| [ontop/ontop](https://github.com/ontop/ontop) | 将关系型数据库映射为虚拟 RDF 知识图谱并通过 SPARQL 查询的 OBDA 平台。 | Java | 914 | `java` `obda` `ontop` `owl` |
...
| [kitfunso/hippo-memory](https://github.com/kitfunso/hippo-memory) | 🧠 受生物学启发的 AI Agent 记忆系统 — 衰减、检索强化、巩固。 | TypeScript | 727 |  |
...
| [zosmaai/pi-llm-wiki](https://github.com/zosmaai/pi-llm-wiki) | 自维护的 Obsidian 兼容知识库，将原始资料转化为相互链接的 wiki，采用开放知识格式 OKF v0.2。 | TypeScript | 508 | `ai-memory` `interoperability` `karpathy` `knowledge-base` |
| [MaibornWolff/codecharta](https://github.com/MaibornWolff/codecharta) | CodeCharta：将代码库架构与质量指标转化为交互式可视化地图，辅助架构决策 | TypeScript | 492 | `3d-map` `analyzer` `angular` `city-map` |
| [GraphRAG-Bench/GraphRAG-Benchmark](https://github.com/GraphRAG-Bench/GraphRAG-Benchmark) | GraphRAG-Bench：评估 GraphRAG 模型的官方 benchmark（ICLR'26） | Python | 482 | `analysis` `benchmark` `dataset` `graphrag` |
...
| [KRR-Oxford/DeepOnto](https://github.com/KRR-Oxford/DeepOnto) | DeepOnto：牛津出品的本体工程 Python 包，结合深度学习与语言模型实现本体对齐与推理。 | Python | 311 | `deep-learning` `language-model` `ontologies` `ontology-engineering` |
...
| [penpot/penpot](https://github.com/penpot/penpot) | Penpot：面向设计与代码协作的开源设计工具 | Clojure | 58.7k | `clojure` `clojurescript` `design` `prototyping` |
| [tldraw/tldraw](https://github.com/tldraw/tldraw) | tldraw：非常好用的无限画布白板 SDK | TypeScript | 49.8k | `canvas` `collaboration` `design` `diagram` |
| [roboflow/supervision](https://github.com/roboflow/supervision) | 可复用的计算机视觉工具库，支持目标检测、实例分割、跟踪和视频处理，兼容 YOLO、PyTorch、TensorFlow。 | Python | 49.5k | `classification` `coco` `computer-vision` `deep-learning` |
| [google-labs-code/design.md](https://github.com/google-labs-code/design.md) | DESIGN.md 规范：用结构化文档让 coding agents 持续理解一个设计系统的视觉身份 | TypeScript | 27.3k |  |
| [danielgatis/rembg](https://github.com/danielgatis/rembg) | 图片背景移除工具 | Python | 24.3k | `background-removal` `image-processing` `python` |
...
| [img2threejs/img2threejs](https://github.com/img2threejs/img2threejs) | img2threejs：将参考图像中的物体重建为 code-only、可动画的 Three.js 3D 模型，token 高效的图片转 3D 工具。 | Python | 12k | `3d` `ai-agents` `claude-code` `computer-graphics` |
| [freestylefly/awesome-gpt-image-2](https://github.com/freestylefly/awesome-gpt-image-2) | GPT-Image2 工业级提示词引擎与模板库，470+ 案例逆向工程，20+ 套工业级模板，提炼为可复用 Skills。 | JavaScript | 10.9k | `agents` `ai-image-generation` `chatgpt` `dsh-plugin` |
| [Nutlope/logocreator](https://github.com/Nutlope/logocreator) | 免费开源 Logo 生成器，由 Together AI 上的 Flux 模型提供支持。 | TypeScript | 8.2k |  |
...
| [chatfire-AI/huobao-canvas](https://github.com/chatfire-AI/huobao-canvas) | 火宝无限画布：文生图、图生图、图生视频、多模型切换，兼容 OpenAI 标准格式 | Vue | 762 |  |
| [markfulton/NanoBananaEditor](https://github.com/markfulton/NanoBananaEditor) | 最先进的 Nano Banana 图像生成与编辑应用，集成 reference image、image mask、版本历史等 | TypeScript | 707 | `aiimages` `bolt` `imageediting` `imageeditor` |
...
| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [harry0703/MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo) | 利用 AI 大模型，一键生成高清短视频 | Python | 105.1k | `ai-video-generator` `content-creation` `ffmpeg` `instagram-reels` |
| [hacksider/Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam) | Real-time 换脸与一键视频深伪工具，仅需单张图片即可实时替换脸部并直播输出。 | Python | 96k | `ai` `ai-deep-fake` `ai-face` `ai-webcam` |
| [OpenCut-app/OpenCut](https://github.com/OpenCut-app/OpenCut) | OpenCut：开源的 CapCut 替代品 | TypeScript | 84.3k | `editor` `oss` `videoeditor` |
...
| [calesthio/OpenMontage](https://github.com/calesthio/OpenMontage) | 全球首个开源 agentic 视频生产系统，12 条 pipeline，从脚本到成片全自动生产。 | Python | 48.5k | `agent` `agentic-ai` `ai` `claude` |
...
| [ATH-MaaS/Pixelle-Video](https://github.com/ATH-MaaS/Pixelle-Video) | AI 全自动短视频引擎，支持从脚本到成片的端到端视频生成流程。 | Python | 26.8k | `aigc` `comfyui` `image-generation` `tts` |
...
| [chatfire-AI/huobao-drama](https://github.com/chatfire-AI/huobao-drama) | 🎬 火宝短剧：基于 AI 的一站式短剧生成平台，一句话生成完整短剧，从剧本到成片全自动化 | Vue | 14k |  |
| [waooAI/waoowaoo](https://github.com/waooAI/waoowaoo) | 工业级 AI 影视全流程生产平台，支持从短剧到真人剧的好莱坞级工作流，提供可控影视 AI Agent 生产线。 | TypeScript | 13.6k | `ai-agent` `ai-agents` `automation` `film-production` |
...
| [HKUDS/ViMax](https://github.com/HKUDS/ViMax) | ViMax：集导演、编剧、制片与视频生成于一体的 agentic 视频生成框架。 | Python | 12k | `agentic-aigc` `video-generation` |
| [linyqh/NarratoAI](https://github.com/linyqh/NarratoAI) | 基于 AI 大模型，一键实现视频自动解说与剪辑，支持多语言输出。 | Python | 10.7k | `aiagent` `aiops` `gemini-api` `llm` |
...
| [lipku/LiveTalking](https://github.com/lipku/LiveTalking) | 实时交互式流媒体数字人框架，支持音视频驱动与多种数字人方案。 | Python | 8.8k | `aigc` `digihuman` `digital-human` `er-nerf` |
| [zhouxiaoka/autoclip](https://github.com/zhouxiaoka/autoclip) | AutoClip：AI 驱动的视频高光提取与剪辑二创工具 | Python | 6.4k | `ai` `ai-agents` `ai-tools` `ai-video` |
...
| [Forget-C/Jellyfish](https://github.com/Forget-C/Jellyfish) | AI 短剧端到端生产工作台，覆盖剧本输入、分镜结构化、角色一致性管理、镜头准备与视频生成全流程。 | Python | 6k | `ai` `short-drama` |
...
| [xuanyustudio/LocalMiniDrama](https://github.com/xuanyustudio/LocalMiniDrama) | 开源本地 AI 短剧 & 漫剧生成工具，从故事到成片一站式完成，支持完全离线运行。 | JavaScript | 1.3k | `ai` `ai-agent` `ai-mini-drama` `ai-video` |
...
| [huangserva/ComfyUI_MiniMaxH3_Director](https://github.com/huangserva/ComfyUI_MiniMaxH3_Director) | ComfyUI 的 MiniMax H3 Director 视频生成工作流配置。 | — | 673 |  |
...
| [OpenBMB/VoxCPM](https://github.com/OpenBMB/VoxCPM) | VoxCPM2：无 tokenizer 架构的多语言 TTS 模型，支持创意声音设计与高保真语音克隆。 | Python | 35.8k | `audio` `deeplearning` `minicpm` `multilingual` |
...
| [ysharma3501/LuxTTS](https://github.com/ysharma3501/LuxTTS) | LuxTTS：高质量极速语音克隆 TTS 模型，达到 150× 实时速度的语音合成引擎。 | Python | 5.1k |  |
...
| [hugohe3/ppt-master](https://github.com/hugohe3/ppt-master) | AI 从任意文档生成可编辑的 PowerPoint，支持原生形状动画、可编辑图表、扬声器注释与自定义模板。 | Python | 47.4k | `ai-agent` `aippt` `office` `powerpoint` |
| [zarazhangrui/frontend-slides](https://github.com/zarazhangrui/frontend-slides) | Create beautiful slides on the web using Claude's frontend skills | JavaScript | 27.7k | `ai-slides` `anthropic` `claude` `claude-code` |
...
| [presenton/presenton](https://github.com/presenton/presenton) | Open-Source AI Presentation Generator and API (Gamma, Beautiful AI, Decktopus Alternative) | TypeScript | 9.6k | `ai-agent` `ai-presentation` `api` `gamma` |
| [1weiho/open-slide](https://github.com/1weiho/open-slide) | 🪄 专为 AI Agent 设计的开源 Slide 框架 — 一句 prompt 直接出整套精美幻灯片。 | TypeScript | 6.5k | `agent` `react` `slides` |
...
| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [D4Vinci/Scrapling](https://github.com/D4Vinci/Scrapling) | 自适应 Python 爬虫框架，支持单次请求到全量爬取，内置 MCP server 与隐身模式。 | Python | 74.7k | `ai` `ai-scraping` `automation` `crawler` |
...
| [NanmiCoder/MediaCrawler](https://github.com/NanmiCoder/MediaCrawler) | 小红书/抖音/快手/B 站/微博/百度贴吧/知乎 等平台的笔记、视频与评论爬虫 | Python | 62.6k |  |
...
| [tamnd/kage](https://github.com/tamnd/kage) | Kage：将任意网站镜像为可离线查看的静态页面，自动剥离 JavaScript，Go 实现。 | Go | 3.2k |  |
...
| [liyedanpdx/reddit-ai-trends](https://github.com/liyedanpdx/reddit-ai-trends) | 抓取 Reddit AI 社区，用 DeepSeek R1 总结趋势，每日排名热点话题 | Python | 860 | `ai` `deepseek-r1` `ranking` `reports` |
...
| [otter1101/blogger-distiller](https://github.com/otter1101/blogger-distiller) | 【小红书 2 万人看过的——博主蒸馏器】输入小红书博主名，蒸馏 TA 的认知和内容打法装进你的 AI | Python | 573 |  |
| [flack0x/trendspyg](https://github.com/flack0x/trendspyg) | Free, open-source Python library for Google Trends data - pytrends alternative with 188K+ configuration options. | Python | 40 | `cli` `data-analysis` `google-trends` `google-trends-api` |

### 内容发布与自媒体 (14)

| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [gitroomhq/postiz-app](https://github.com/gitroomhq/postiz-app) | 📨 终极 agentic 社媒排期工具 | TypeScript | 34.8k | `nextjs` `open-source` `open-source-social-media-scheduling-tool` `oss` |
...
| [leaperone/MultiPost-Extension](https://github.com/leaperone/MultiPost-Extension) | MultiPost：一键将内容发布到多个社交媒体平台的浏览器扩展。 | TypeScript | 3k | `article` `automation` `content-platform` `marketing` |
...
| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [shadcn-ui/ui](https://github.com/shadcn-ui/ui) | shadcn/ui：精心设计的可访问组件与代码分发平台 | TypeScript | 121.5k | `base-ui` `components` `laravel` `nextjs` |
| [juliangarnier/anime](https://github.com/juliangarnier/anime) | anime.js：JavaScript 动画引擎 | JavaScript | 72.2k | `animation` `anime` `canvas` `css` |
| [chenglou/pretext](https://github.com/chenglou/pretext) | Fast, accurate & comprehensive text measurement & layout | TypeScript | 49.9k |  |
| [DavidHDev/react-bits](https://github.com/DavidHDev/react-bits) | 开源的、动画化、可交互、可定制的 React 组件集合 | JavaScript | 45.7k | `3d` `animations` `component-library` `components` |
| [facebook/astryx](https://github.com/facebook/astryx) | Facebook 出品的开源设计系统，高度可定制且为 AI Agent 适配，组件开箱即用。 | TypeScript | 12.1k |  |
| [assistant-ui/assistant-ui](https://github.com/assistant-ui/assistant-ui) | assistant-ui：TypeScript/React AI 聊天 UI 组件库，快速构建精美 AI 对话界面。 | TypeScript | 11.7k | `ai-chatbot` `chatbot` `conversational-ai` `copilot` |
...
| [galacean/effects-runtime](https://github.com/galacean/effects-runtime) | Galacean Effects：高性能 Web 动画效果运行时，支持粒子特效与复杂动画渲染 | TypeScript | 744 | `2d` `3d` `animation` `effects` |
| [qiuyiwu1989-star/opendesign](https://github.com/qiuyiwu1989-star/opendesign) | 通过 Playwright 与视觉 LLM 从现有网页中提取可复用设计 token 的开放标准工具，AI-ready，兼容 Claude 与 Cursor。 | JavaScript | 66 | `ai` `ai-agents` `claude` `claude-code` |
...
| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [electron/electron](https://github.com/electron/electron) | 使用 JavaScript、HTML 和 CSS 构建跨平台桌面应用的开源框架，是 VS Code、Slack 等知名应用的底层技术。 | C++ | 122.5k | `c-plus-plus` `chrome` `css` `electron` |
| [tauri-apps/tauri](https://github.com/tauri-apps/tauri) | Tauri：用 web 前端构建更小、更快、更安全的桌面与移动应用 | Rust | 110.3k | `desktop-app` `high-performance` `mobile-app` `native-app` |
...
| [Sjj1024/PakePlus](https://github.com/Sjj1024/PakePlus) | 一键将任意网页 / HTML / Vue / React 项目打包为体积 <5MB 的跨平台桌面与移动应用。 | HTML | 14.3k | `pacbao` `pake` `pakeplus` `rust` |
...
| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [router-for-me/CLIProxyAPI](https://github.com/router-for-me/CLIProxyAPI) | Wrap Gemini CLI, Antigravity, ChatGPT Codex, Claude Code as an OpenAI/Gemini/Claude/Codex compatible API service, allowing you to enjoy the free Gemini 3.1 Pro, GPT 5.5, Claude model through API | Go | 47.5k | `antigravity` `claude-code` `cluade` `codex` |
| [QuantumNous/new-api](https://github.com/QuantumNous/new-api) | 统一 AI 模型聚合分发网关，支持 OpenAI、Claude、Gemini 等格式互转，适合个人与企业模型管理。 | Go | 45.3k | `ai-gateway` `claude` `deepseek` `gemini` |
| [songquanpeng/one-api](https://github.com/songquanpeng/one-api) | LLM API 管理与分发系统，支持 OpenAI/Anthropic Claude/Gemini/DeepSeek/通义千问等，统一 API 适配 | JavaScript | 36.4k | `api` `api-gateway` `azure-openai-api` `chatgpt` |
| [sgl-project/sglang](https://github.com/sgl-project/sglang) | 高性能 LLM 与多模态模型推理服务框架，优化批处理和 KV 缓存，支持 DeepSeek、LLaMA 等主流开源模型。 | Python | 31.9k | `attention` `blackwell` `cuda` `deepseek` |
...
| [velobase/velobase-harness](https://github.com/velobase/velobase-harness) | 开源 AI 应用 SaaS 样板，内置 Stripe 支付、联盟营销、归因追踪与按用量计费，基于 T3 Stack + Next.js 16 | TypeScript | 581 | `ai-agent` `ai-saas` `billing` `monetization` |

### 自托管 / PaaS (10)

| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [louislam/uptime-kuma](https://github.com/louislam/uptime-kuma) | 颜值出众的自托管服务监控工具，支持多种通知渠道、状态页面与 Docker 部署。 | JavaScript | 90.2k | `docker` `monitor` `monitoring` `responsive` |
...
| [coollabsio/coolify](https://github.com/coollabsio/coolify) | Coolify：开源、可自托管的 Vercel/Heroku/Netlify 替代品，部署静态站点、数据库与全栈应用 | PHP | 60.7k | `coolify` `databases` `deployment` `docker` |
| [frappe/erpnext](https://github.com/frappe/erpnext) | 免费开源企业资源规划（ERP）系统，适合中小企业自托管部署。 | Python | 38.2k | `accounting` `asset-management` `crm` `distribution` |
| [chatwoot/chatwoot](https://github.com/chatwoot/chatwoot) | 开源全渠道客服平台，支持实时聊天、邮件与工单，可自托管替代 Intercom 和 Zendesk。 | Ruby | 35.9k | `actioncable` `chat-widget` `conversation` `customer-support` |
| [opensandbox-group/OpenSandbox](https://github.com/opensandbox-group/OpenSandbox) | OpenSandbox：安全、快速、可扩展的 AI agent 沙盒运行时，支持自托管部署。 | Python | 14.1k | `ai` `ai-agent` `ai-infra` `kubernetes` |
...
| [oblien/openship](https://github.com/oblien/openship) | Openship：自托管部署平台，支持 AI agent 的一站式基础设施管理。 | TypeScript | 10.9k | `agents` `ai` `deployments` `self-hosted` |
| [frappe/hrms](https://github.com/frappe/hrms) | 基于 Frappe/ERPNext 框架的开源人力资源与薪资管理系统，支持考勤、离职等全流程。 | Python | 8.6k | `attendance` `employee` `erpnext` `exits` |
...
| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [ollama/ollama](https://github.com/ollama/ollama) | Get up and running with Kimi-K2.5, GLM-5, MiniMax, DeepSeek, gpt-oss, Qwen, Gemma and other models. | Go | 178.7k | `deepseek` `gemma` `gemma3` `glm` |
...
| [headroomlabs-ai/headroom](https://github.com/headroomlabs-ai/headroom) | 在 LLM 接收之前压缩工具输出、日志、文件与 RAG chunk，节省 60-95% token，同时保持答案质量。支持 Library、Proxy 与 MCP server 三种用法。 | Python | 66.6k | `agent` `ai` `anthropic` `claude-code` |
...
| [HKUDS/CLI-Anything](https://github.com/HKUDS/CLI-Anything) | 将任意软件封装为 agent 原生 CLI 接口的统一工具套件，让 AI agent 可无缝发现、学习和调用任意工具。 | Python | 47.7k |  |
...
| [vercel/ai](https://github.com/vercel/ai) | Vercel AI Toolkit：构建 AI 应用与 agent 的免费开源 TypeScript SDK | TypeScript | 26.2k | `anthropic` `artificial-intelligence` `gemini` `generative-ai` |
...
| [cactus-compute/cactus](https://github.com/cactus-compute/cactus) | Low-latency AI engine for mobile devices & wearables | C++ | 5.8k | `ai` `android` `arm` `edge` |
...
| [antirez/h3.c](https://github.com/antirez/h3.c) | h3.c：antirez 为 Mac 打造的 MiniMax H3 本地推理引擎，C 实现，极速运行。 | C | 2.1k |  |
...
| [RyanCodrai/turbovec](https://github.com/RyanCodrai/turbovec) | TurboVec：基于 TurboQuant 的高性能向量索引，Rust 编写、提供 Python 绑定 | Rust | 14.8k | `ann` `avx512` `embedding` `embeddings` |
...
| [GoogleCloudPlatform/knowledge-catalog](https://github.com/GoogleCloudPlatform/knowledge-catalog) | Google Cloud 数据目录工具与示例合集，提供数据资产元数据管理与数据治理的最佳实践。 | TypeScript | 8.7k |  |
...
| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [AppFlowy-IO/AppFlowy](https://github.com/AppFlowy-IO/AppFlowy) | AppFlowy：开源的 AI 协作工作空间，Notion 替代品 | Dart | 75.6k | `blog` `confluence-alternative` `content-management` `content-services` |
| [toeverything/AFFiNE](https://github.com/toeverything/AFFiNE) | AFFiNE：把规划、整理、创建结合在一起的下一代知识库（Notion 与 Miro 的替代品） | TypeScript | 71.6k | `app` `crdt` `editor` `electron` |
...
| [logseq/logseq](https://github.com/logseq/logseq) | Logseq：隐私优先的开源知识管理与协作平台 | Clojure | 44.5k | `clojure` `clojurescript` `git` `graph` |
...
| [block/buzz](https://github.com/block/buzz) | Buzz：Block 开源的「蜂巢思维」分布式通信协作平台，Rust 实现。 | Rust | 27.8k |  |
| [refactoringhq/tolaria](https://github.com/refactoringhq/tolaria) | Tolaria：管理 Markdown 知识库的桌面应用。 | TypeScript | 19.5k |  |
| [tw93/Kami](https://github.com/tw93/Kami) | Kami — 「好内容值得好纸张」，美化内容阅读与展示体验的开源工具。 | HTML | 10.6k |  |
...
| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [twentyhq/twenty](https://github.com/twentyhq/twenty) | Twenty：面向 AI 设计的开源 Salesforce 替代品 | TypeScript | 55k | `crm` `crm-system` `customer` `good-first-issue` |
| [monicahq/monica](https://github.com/monicahq/monica) | Personal CRM：记录朋友、家人和商业关系的所有信息 | PHP | 25k | `crm` `family` `friends` `hacktoberfest` |
| [fbuchner/meerkat-crm](https://github.com/fbuchner/meerkat-crm) | 面向个人生活的 CRM | Go | 274 | `contact-management` `self-hosted` |
...
| [Thysrael/Horizon](https://github.com/Thysrael/Horizon) | AI 驱动的个人新闻雷达，每日生成英中双语简报。 | Python | 8.9k | `aggregator` `feishu-bot` `llm` `mcp` |

### 论坛 / 博客平台 (3)

| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [TryGhost/Ghost](https://github.com/TryGhost/Ghost) | Ghost：现代出版、会员、订阅与 newsletter 的独立技术 | JavaScript | 54.8k | `blogging` `cms` `ghost` `javascript` |
...
| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [TauricResearch/TradingAgents](https://github.com/TauricResearch/TradingAgents) | TradingAgents：多 agent LLM 金融交易框架 | Python | 98.6k | `agent` `finance` `llm` `multiagent` |
| [OpenBB-finance/OpenBB](https://github.com/OpenBB-finance/OpenBB) | Financial data platform for analysts, quants and AI agents. | Python | 72k | `ai` `crypto` `derivatives` `economics` |
| [ZhuLinsen/daily_stock_analysis](https://github.com/ZhuLinsen/daily_stock_analysis) | LLM驱动的 A/H/美股智能分析器：多数据源行情 + 实时新闻 + LLM决策仪表盘 + 多渠道推送，零成本定时运行，纯白嫖. LLM-powered stock analysis system for A/H/US markets. | Python | 63.1k | `a-stock` `ai-agent` `aigc` `llm` |
| [virattt/ai-hedge-fund](https://github.com/virattt/ai-hedge-fund) | AI Hedge Fund Team：模拟对冲基金团队的 AI agent | Python | 62.9k |  |
| [shiyu-coder/Kronos](https://github.com/shiyu-coder/Kronos) | Kronos：金融市场语言的基础模型 | Python | 37.4k |  |
...
| [edmcouncil/fibo](https://github.com/edmcouncil/fibo) | FIBO：金融行业业务本体，为金融数据定义标准化语义模型与词汇 | Shell | 668 | `finance` `financial-services` `fintech` `ontology` |
...
| [gengjiawen/buffett-chinese](https://github.com/gengjiawen/buffett-chinese) | 巴菲特价值投资的中文资料 | JavaScript | 275 |  |

### 职业 / 求职 (6)

| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [santifer/career-ops](https://github.com/santifer/career-ops) | 基于 Claude Code 的 AI 求职系统，含 14 个 skill、Go dashboard、PDF 生成、批处理 | JavaScript | 64.1k | `ai` `ai-agent` `anthropic` `ats` |
| [MadsLorentzen/ai-job-search](https://github.com/MadsLorentzen/ai-job-search) | 基于 Claude Code 的 AI 求职框架，可自动评估职位匹配度、定制简历并生成求职信。 | TypeScript | 32k | `ai` `ai-agents` `career` `claude-code` |
| [xdash/FDE-the-Guidance-Book-of-Forward-Deployed-Engineer](https://github.com/xdash/FDE-the-Guidance-Book-of-Forward-Deployed-Engineer) | 基于《增长黑客》框架整理的 FDE（前沿部署工程师）零基础入门指南，涵盖技术能力建设与客户成功全流程。 | — | 4.1k |  |
...
| [XiaomingX/jobleap-cn-ai-job-search](https://github.com/XiaomingX/jobleap-cn-ai-job-search) | 基于 AI 的智能求职平台 jobleap.cn，集成模拟面试、面试押题、简历模板、岗位匹配 | Python | 153 | `awesome` `jobsearch` |
...
| [XiaomingX/ai-money-maker-handbook](https://github.com/XiaomingX/ai-money-maker-handbook) | AI 副业赚钱大集合，教你如何利用 AI 做副业项目 | CSS | 3.7k | `awesome` `jobleap` |
| [codeman008/Financial_freedom](https://github.com/codeman008/Financial_freedom) | 最全赚钱投资技术指南：涵盖理财、投资与副业变现的系统化知识库（中文）。 | — | 2.9k |  |
...
| [huangyun101/AI-Business-Hunter](https://github.com/huangyun101/AI-Business-Hunter) | 汇集利用 AI 实现个人变现的小生意创意与案例，面向独立开发者与副业探索者。 | — | 133 |  |
...
| [AgriciDaniel/claude-ads](https://github.com/AgriciDaniel/claude-ads) | Comprehensive paid advertising audit & optimization skill for Claude Code. 250+ checks across Google, Meta, YouTube, LinkedIn, TikTok, Microsoft & Apple Ads with weighted scoring, parallel agents, industry templates, and AI creative generation. | Python | 8.1k | `agent-skills` `ai` `ai-marketing` `claude-code` |
...
| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [shareAI-lab/learn-claude-code](https://github.com/shareAI-lab/learn-claude-code) | Bash is all you need：从 0 到 1 构建一个 nano claude code 风格的 agent harness | Python | 74.5k | `agent` `agent-development` `ai-agent` `claude` |
| [datawhalechina/hello-agents](https://github.com/datawhalechina/hello-agents) | 📚《从零开始构建智能体》——从零开始的 Agent 原理与实践教程 | Python | 73.3k | `agent` `llm` `rag` `tutorial` |
| [bojieli/ai-agent-book](https://github.com/bojieli/ai-agent-book) | 《深入理解 AI Agent：设计原理与工程实践》开源图书，含全书正文、PDF 与配套代码 | Python | 38.3k | `agent` `agent-memory` `ai-agent` `book` |
| [datawhalechina/happy-llm](https://github.com/datawhalechina/happy-llm) | 📚 从零开始构建大模型 | Jupyter Notebook | 33k | `agent` `llm` `rag` |
| [datawhalechina/self-llm](https://github.com/datawhalechina/self-llm) | 《开源大模型食用指南》：基于 Linux 环境快速微调（全参/Lora）、部署国内外开源 LLM/MLLM 教程 | Jupyter Notebook | 31.7k | `chatglm` `chatglm3` `gemma-2b-it` `glm-4` |
...
| [datawhalechina/llm-deploy](https://github.com/datawhalechina/llm-deploy) | 大模型/LLM 推理与部署的理论与实践 | — | 419 | `knowledge-distillation` `llm` `llm-deploy` `lora` |

### LLM 教程（英文） (21)

| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [rasbt/LLMs-from-scratch](https://github.com/rasbt/LLMs-from-scratch) | 用 PyTorch 从零实现一个 ChatGPT 风格的 LLM，逐步深入 | Jupyter Notebook | 102.8k | `ai` `artificial-intelligence` `attention-mechanism` `deep-learning` |
| [mlabonne/llm-course](https://github.com/mlabonne/llm-course) | 学习 LLM 的课程，含 roadmap 与 Colab notebook | — | 81.7k | `course` `large-language-models` `llm` `machine-learning` |
| [karpathy/nanochat](https://github.com/karpathy/nanochat) | The best ChatGPT that $100 can buy. | Python | 57.3k |  |
| [anthropics/claude-cookbooks](https://github.com/anthropics/claude-cookbooks) | Anthropic 官方出品的 Claude API 实战 Notebook 合集，展示各种创意使用方法与最佳实践。 | Jupyter Notebook | 51.7k |  |
| [luongnv89/claude-howto](https://github.com/luongnv89/claude-howto) | Claude Code 可视化示例指南，从入门概念到高阶 Agent，附即用模板 | Python | 41.1k | `claude-code` `guide` `tutorial` |
| [anthropics/prompt-eng-interactive-tutorial](https://github.com/anthropics/prompt-eng-interactive-tutorial) | Anthropic 出品的交互式 prompt engineering 教程 | Jupyter Notebook | 37.7k |  |
| [patchy631/ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub) | LLM、RAG 与真实世界 AI agent 应用的深度教程 | Jupyter Notebook | 37k | `agents` `ai` `llms` `machine-learning` |
| [anthropics/financial-services](https://github.com/anthropics/financial-services) | Anthropic 官方金融服务行业 Claude API 应用示例与最佳实践合集 | Python | 34.3k |  |
| [NirDiamant/RAG_Techniques](https://github.com/NirDiamant/RAG_Techniques) | RAG（Retrieval-Augmented Generation）系统的高级技术合集，每个技术都有详细 notebook 教程 | Jupyter Notebook | 29.1k | `agentic-rag` `ai` `embeddings` `generative-ai` |
| [humanlayer/12-factor-agents](https://github.com/humanlayer/12-factor-agents) | 构建可投入生产的 LLM 驱动软件的 12 条原则，涵盖 AI Agent 工程最佳实践与设计模式。 | TypeScript | 25.3k | `12-factor` `12-factor-agents` `agents` `ai` |
...
| [pageman/sutskever-30-implementations](https://github.com/pageman/sutskever-30-implementations) | Sutskever 30 篇论文的代码实现合集 | Jupyter Notebook | 4.3k |  |
...
| [tradecatlabs/vibe-coding-cn](https://github.com/tradecatlabs/vibe-coding-cn) | Vibe Coding 从入门到精通中文教程，涵盖 AI 结对编程工作流、Prompt 设计、Skill、Workflow 与 Codex 实战指南 | Python | 15.9k | `ai` `ai-agent` `ai-agents` `ai-coding` |
...
| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [donnemartin/system-design-primer](https://github.com/donnemartin/system-design-primer) | 学习设计大规模系统，准备系统设计面试，含 Anki 闪卡 | Python | 364.3k | `design` `design-patterns` `design-system` `development` |
...
| [karanpratapsingh/system-design](https://github.com/karanpratapsingh/system-design) | 学习大规模系统设计与系统设计面试准备 | — | 45.6k | `architecture` `distributed-systems` `engineering` `interview` |
...
| [ashishps1/awesome-system-design-resources](https://github.com/ashishps1/awesome-system-design-resources) | 用免费资源学习系统设计概念并准备面试 | Java | 40.7k | `awesome` `backend` `computer-science` `distributed-systems` |
...
| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [codecrafters-io/build-your-own-x](https://github.com/codecrafters-io/build-your-own-x) | 通过从零重建你最喜欢的技术来精通编程 | Markdown | 540.3k | `awesome-list` `free` `programming` `tutorial-code` |
| [practical-tutorials/project-based-learning](https://github.com/practical-tutorials/project-based-learning) | 项目驱动的学习教程精选清单 | Python | 279.5k | `beginner-project` `cpp` `golang` `javascript` |
| [lydiahallie/javascript-questions](https://github.com/lydiahallie/javascript-questions) | 一长串（进阶）JavaScript 问题与解释 | — | 65.3k |  |
| [xai-org/x-algorithm](https://github.com/xai-org/x-algorithm) | X（原 Twitter）「为你推荐」信息流的开源推荐算法，由 xAI 发布，Rust 实现，可学习研究。 | Rust | 31.6k |  |
...
| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [sindresorhus/awesome](https://github.com/sindresorhus/awesome) | 😎 关于各类有趣主题的 awesome 清单总集 | — | 496.7k | `awesome` `awesome-list` `lists` `resources` |
| [vinta/awesome-python](https://github.com/vinta/awesome-python) | Python 框架、库、工具与资源的精选清单 | Python | 314.4k | `awesome` `collections` `python` `python-frameworks` |
| [x1xhlol/system-prompts-and-models-of-ai-tools](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools) | Cursor / Devin / Lovable / v0 等 AI 工具的 system prompt、内部 tool 与 AI 模型合集 | — | 142.9k | `ai` `bolt` `cluely` `copilot` |
| [Shubhamsaboo/awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps) | 100+ AI Agent & RAG apps you can actually run — clone, customize, ship. | Python | 132.9k | `agents` `llms` `python` `rag` |
| [VoltAgent/awesome-design-md](https://github.com/VoltAgent/awesome-design-md) | A collection of DESIGN.md files inspired by popular brand design systems. Drop one into your project and let coding agents generate a matching UI. | — | 108.9k | `awesome-list` `design-md` `design-system` `design-tokens` |
| [punkpeye/awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | MCP servers 合集 | — | 92.5k | `ai` `mcp` |
| [asgeirtj/system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks) | 持续更新的各大 AI 工具（Claude、ChatGPT、Codex、Gemini、Grok 等）system prompt 泄露合集。 | JavaScript | 63k | `ai` `ai-agents` `ai-prompts` `anthropic` |
| [hesreallyhim/awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code) | Claude Code 的精选 skills、hooks、slash-commands、agent orchestrator、应用与插件 | Python | 52.5k | `agent-skills` `agentic-code` `agentic-coding` `ai-workflow-optimization` |
| [VoltAgent/awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) | OpenClaw skills 的精选合集，从官方 Skills Registry 筛选并分类的 5400+ skill | — | 52k | `agent-skills` `awesome` `awesome-list` `awesome-lists` |
...
| [hasaneyldrm/exercises-dataset](https://github.com/hasaneyldrm/exercises-dataset) | 涵盖 433 个健身动作的综合数据集，含动作名称、分类、目标肌群、器材说明及演示视频。 | HTML | 19.8k | `dataset` `exercise-database` `exercises` `fitness` |
...
| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [usestrix/strix](https://github.com/usestrix/strix) | Strix：开源 AI 渗透测试工具，自动发现并修复应用安全漏洞，内置 red teaming 与安全自动化流程。 | Python | 53.5k | `agents` `ai-hacking` `ai-penetration-testing` `ai-pentesting` |
| [KeygraphHQ/shannon](https://github.com/KeygraphHQ/shannon) | Shannon Lite is an autonomous, white-box AI pentester for web applications and APIs. It analyzes your source code, identifies attack vectors, and executes real exploits to prove vulnerabilities before they reach production. | TypeScript | 46.9k | `ai-penetration-testing` `ai-security` `api-security` `appsec` |
| [soxoj/maigret](https://github.com/soxoj/maigret) | 🕵️ 通过用户名在 3000+ 网站收集个人信息档案的 OSINT 工具 | Python | 36.8k | `cli` `cybersecurity` `identification` `information-gathering` |
...
| [p-e-w/heretic](https://github.com/p-e-w/heretic) | 针对语言模型的全自动安全过滤绕过工具，支持主流 LLM 的内置审查过滤器移除 | Python | 27.8k | `abliteration` `llm` `transformer` |
...
| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [freeCodeCamp/freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp) | freeCodeCamp 开源课程平台，提供数学、编程与计算机科学的免费系统性学习资源。 | TypeScript | 454.2k | `careers` `certification` `community` `curriculum` |
...
| 仓库 | 描述 | 语言 | ⭐ | 标签 |
|---|---|---|---|---|
| [Renhuai123/ziwei-doushu](https://github.com/Renhuai123/ziwei-doushu) | 紫微斗数开源排盘引擎，基于倪海夏《天纪》体系，含完整四化系统与格局知识库。 | TypeScript | 3.5k | `bazi` `chinese-astrology` `divination` `fortune-telling` |
...
| [MengTo/kage](https://github.com/MengTo/kage) | Kage：Three.js 实时渲染的五章京都山寺夜间漫步交互体验，沉浸式艺术项目。 | HTML | 1.1k | `creative-coding` `generative-art` `interactive-storytelling` `japanese-design` |
| [context-labs/aella-data-explorer](https://github.com/context-labs/aella-data-explorer) | LAION 研究论文数据集的可视化浏览器 | TypeScript | 973 |  |
| [FANzR-arch/Numerologist_skills](https://github.com/FANzR-arch/Numerologist_skills) | 🔮 给 LLM 做中国玄学的「紧箍咒」工程框架 — 减少赛博半仙的幻觉。 | Python | 944 |  |
