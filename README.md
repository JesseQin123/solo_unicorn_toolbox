...
**Total: 446 repositories** · Auto-generated by `scripts/build-readme.py`. To add new entries, paste GitHub URLs into [`inbox.md`](./inbox.md).

---

## Table of Contents

- [🤖 AI Agents & Coding Harnesses (77)](#-ai-agents--coding-harnesses)
- [🛠 AI Agent Skills & MCP (29)](#-ai-agent-skills--mcp)
- [🌐 Browser & Web Automation (12)](#-browser--web-automation)
- [🧠 RAG / Knowledge Graph / Memory (39)](#-rag--knowledge-graph--memory)
- [🎨 Multimedia AI (49)](#-multimedia-ai)
...
- [🌈 Misc / Lifestyle (26)](#-misc--lifestyle)
